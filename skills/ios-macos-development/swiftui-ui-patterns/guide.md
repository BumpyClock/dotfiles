...
- In addition to the references below, use `web_search` / `web_fetch` to consult current Apple Developer documentation when SwiftUI APIs, availability, or platform guidance may have changed.
...
- Paths to existing examples in the target repo when available.

## Adding a new component reference

- Create `references/<component>.md`.
- Keep it short and actionable; link to concrete target-repo files when helpful.
