...
- In addition to the references above, use `web_search` / `web_fetch` to consult current Apple Developer documentation when SwiftUI APIs, Observation behavior, or platform guidance may have changed.
