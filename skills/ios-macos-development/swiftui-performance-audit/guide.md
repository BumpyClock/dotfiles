...
- In addition to the references above, use `web_search` / `web_fetch` to consult current Apple Developer documentation when Instruments workflows or SwiftUI performance guidance may have changed.
