...
- In addition to the links above, use `web_search` / `web_fetch` to consult current Apple Developer documentation when App Intents APIs or platform behavior may have changed.
