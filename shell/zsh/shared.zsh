...
# Sources managed environment variables, such as API keys.
# Generated by: bun scripts/link-dotfiles/link-dotfiles.ts
...
# Note: cz, ck, ccy, claudex, and claude-grok are wrapper scripts. The linker installs them into ~/.local/bin:
