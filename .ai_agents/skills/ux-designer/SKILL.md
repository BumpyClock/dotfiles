...
This skill enforces precise, crafted design for consumer apps, enterprise software, SaaS dashboards, admin interfaces, and web applications. The philosophy is Jony Ive-level precision with intentional personality — every interface is polished, and each is designed for its specific context. 

UX is not just about aesthetics. It's about understanding the user's needs, behaviors, and emotions. It's about creating a seamless experience that meets the user's expectations and exceeds their needs. Even a CLI tool or TUI benefits from UX design principles.
...
- **What does this product do?** A finance tool needs different energy than a creative tool. A consumer app needs a different tone than an enterprise software.
...
UI has more range than you think. Consider these directions:
