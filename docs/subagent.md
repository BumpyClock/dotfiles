...
- For saved implementation plans, prefer the `subagent-driven-development` skill from the [agent-templates](https://github.com/BumpyClock/agent-templates) repo (`skills_archive/subagent-driven-development/SKILL.md`) when user/runtime permits subagents.
